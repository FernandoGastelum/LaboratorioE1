 ...
 * @author Knocmare
 */
public class frmPruebaEntidad extends javax.swing.JFrame {

    private IPruebaNegocio pruebaNegocio;
    private ICategoriaNegocio categoriaNegocio;
    private IParametroNegocio parametroNegocio;

    public frmPruebaEntidad(IPruebaNegocio pruebaNegocio, ICategoriaNegocio categoriaNegocio, IParametroNegocio parametroNegocio) {
        initComponents();
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        frmPrueba insfrmPrueba = new frmPrueba(pruebaNegocio, categoriaNegocio, parametroNegocio);
        insfrmPrueba.setVisible(true);
        dispose();
    ...
    private void btnCategoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCategoriaActionPerformed
        frmCategoriaEntidad insfrmCategoriaEntidad = new frmCategoriaEntidad(pruebaNegocio, categoriaNegocio, parametroNegocio);
        insfrmCategoriaEntidad.setVisible(true);
        dispose();
    ...
    private void btnParametroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnParametroActionPerformed
        frmParametroEntidad insfrmParametroEntidad = new frmParametroEntidad(pruebaNegocio, categoriaNegocio, parametroNegocio);
        insfrmParametroEntidad.setVisible(true);
        dispose();
